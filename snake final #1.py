...
if user_speed.lower() in ["fast", 'f']:
    snake_speed = 30
elif user_speed.lower() in ["slow", 's']:
    snake_speed = 15
else:
    snake_speed = 22 
...
pop_position = random_border_position() #[random.randrange(1, (window_x//10)) * 10,
                  #random.randrange(1, (window_y//10)) * 10]
pop_spawn = True
...
def game_over():
    ...
    my_font = pygame.font.SysFont(current[2], 50)
...
# Draw powerup
    ...
    #snake_body.insert(0, list(snake_position))
       ...
       # score += 100
        ...
        #time.sleep(20)
    '''
    if fruit_count % 5 == 0 and pop_spawn and snake_position[0] == pop_position[0] and snake_position[1] == pop_position[1]:
        pop_spawn = False
